...
public class TotalRandom extends Total{
	protected String[] korAddress;
	public TotalRandom (Map<Integer, String> StoryNum, String[] address, String[] korAddress) {
	...
	public void start() {
		for (int i = 0; i < StoryNum.size(); i += 1) {
			...
			List<String> korLines = this.storage(korAddress[i]);
